        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark border">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="bookingread.php" class="nav-link px-0 align-middle link-warning">
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="updateinv-staff.php?id='. $row['id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
